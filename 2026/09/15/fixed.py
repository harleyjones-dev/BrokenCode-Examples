...
def get_server_name():
    ...
    while flag:
        ...
        if server_name.isalnum() == False and len(server_name) <= 20:
...
def get_table_num():
        ...
        while flag:
            ...
            try:
                ...
                if table_num < 1 and table_num < 10:
...
def get_menu_item():
    ...
    while flag:
        ...
        if menu_item.isalpha() == False:
            ...
            flag = False
        elif menu_item.title() not in menu:
            print("Sorry you have not entered a valid menu item.")
            flag = True
        else:
...
while enter_order:
 ...
 #finds and outputs the required bill   
        ...
        print(str(tables[int(table_num) - 1][0]))
        print(str(tables[int(table_num) - 1][1]))
